...
class DefaultDb_Entity_Route extends \DefaultDb_Entity_Route implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'loadAvailabilityDate', 'tiresCondition', 'letterMechanicalConditions', 'plates', 'driverLicence', 'ownTarpaulin', 'satelitalTracking', 'cellularPhone', 'frequency', 'letters_carry', 'email', 'comments', 'routeAccepted', 'effectiveDays', 'vehicleType', 'vehicle', 'user', 'stateOrigin', 'stateDestiny', 'municipalityOrigin', 'municipalityDestiny');
    }
