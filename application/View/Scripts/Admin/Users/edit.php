        ...
        <div class="control-group">
          ...
          <div class="controls">
            <select name="role" id="role">
                ...
                <option value="3" <?php echo ($view->user->getType() == 3) ? 'selected="selected"' : ""; ?>>Enviador</option>
                <option value="4" <?php echo ($view->user->getType() == 4) ? 'selected="selected"' : ""; ?>>Transportista</option>
            </select>
          </div>          
        </div>
