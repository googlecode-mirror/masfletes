 ...
 */
class Admin_PackingTypesController extends Model3_Controller
{
    ...
    {
        $this->view->getJsManager()->addJsVar('entity','"PackingType"');
        $this->view->getJsManager()->addJsVar('texto','"eliminar este tipo de paquete"');
        ...
        $repo = $this->getEntityManager('DefaultDb')->getRepository('DefaultDb_Entity_PackingType');
