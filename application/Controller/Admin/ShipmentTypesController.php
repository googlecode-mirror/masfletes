 ...
 */
class Admin_ShipmentTypesController extends Model3_Controller
{
    ...
    {
        $this->view->getJsManager()->addJsVar('entity','"ShipmentType"');
        $this->view->getJsManager()->addJsVar('texto','"eliminar este tipo de carga"');
        ...
        $repo = $this->getEntityManager('DefaultDb')->getRepository('DefaultDb_Entity_ShipmentType');
    ...
    public function formAction()
    {
        ...
        if( !is_null($this->getRequest()->getParam('id')) && is_numeric($this->getRequest()->getParam('id')) )
        {
            ...
            $this->view->dataRequest = $em->getRepository('DefaultDb_Entity_ShipmentType')->find($idReq);
        }
        ...
        if( $this->getRequest()->isPost() )
        {
            ...
            if( is_null($this->view->dataRequest) )
                $entity = new DefaultDb_Entity_ShipmentType();
            else
            {
