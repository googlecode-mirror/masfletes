<h1>Crear Rutas Propias</h1>
NOTA: Esta ruta estará ligada al correo transportista@masfletes.com.
<br />
<br />
<form>
    <table>
        <tr>
            <td>Correo *</td>
            <td><input type="text" value="transportista@masfletes.com" /></td>
        </tr>
        <tr>
            <td>Origen Edo. *</td>
            <td>
        ...
        <tr>
            <td colspan="2"><input type="button" value="Guardar"/></td>
        </tr>
    </table>
</form>