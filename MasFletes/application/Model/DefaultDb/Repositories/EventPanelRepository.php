...
{  
     ...
     public function getEvent()
    {
        ...
        $res = $cnx->executeQuery("SELECT event_panel.id, id_user, coincidence_number,coincidence_event, id_event, event, status, creation_date, data_hidden, DATE_FORMAT(creation_date,GET_FORMAT(DATE, 'EUR')) AS Availability_Date,
