...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'mail.masdistribucion.com.mx';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Prueba Adinistracion MF';
   ...
   * @var string
   */
  public $Host          = 'mail.masdistribucion.com.mx';
   ...
   * @var string
   */
  public $Username      = 'admin@masdistribucion.com.mx';
