...
class DefaultDb_Entity_Shipment extends \DefaultDb_Entity_Shipment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'creation_date', 'frequency', 'shipmentAccepted', 'effectiveDays', 'contactName', 'contactPhone', 'sourceDate', 'sourceAddress', 'destinyDate', 'destinyAddress', 'vehicle', 'vehicleType', 'user', 'stateOrigin', 'stateDestiny', 'municipalityOrigin', 'municipalityDestiny', 'shipmentType');
    }
