            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="Shipment" id="<?php echo $shipment->getId(); ?>" style="cursor:pointer;">
                        <span class="icon-search" title="Detalles"></span>&nbsp;
                        <a alt="Editar" title="Editar" href="<?php echo $this->_view->url($params); ?>"><span class="icon-pencil"></span></a>&nbsp;
                        <a href="#" id="<?php echo $shipment->getId(); ?>" class="deleteItem" title="Eliminar"><span class="icon-remove"></span></a>
                    </td>
                </tr>
                    <?php
                }
