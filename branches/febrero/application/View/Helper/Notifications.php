            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="Notification" id="<?php echo $notification->getId(); ?>" style="cursor:pointer;">
                            ...
                            <a href="<?php echo $this->_view->url($params); ?>"><span class="icon-pencil"></span></a>&nbsp;
                            <a href="#" id="<?php echo $notification->getId(); ?>" class="deleteItem" title="Eliminar"><span class="icon-remove"></span></a>
                        </td>
                </tr>
                <?php
                }
