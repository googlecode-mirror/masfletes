...
class Model3_Site
{
    ...
    public static function setTempMsg($ind,$val)
    {
        $_SESSION['__M3']['tempVar'][$ind] = $val;
    }

    public static function getTempMsg($ind)
    {
        $temp = '';
        if (isset($_SESSION['__M3']['tempVar']))
        {
            if( array_key_exists($ind, $_SESSION['__M3']['tempVar']) )
            {
                $temp = $_SESSION['__M3']['tempVar'][$ind];
                unset($_SESSION['__M3']['tempVar'][$ind]);
                return $temp;
            }
        }
        return false;
