<div class="well">
    ...
    <tr>
        <td><img src="<?php echo $view->getBaseUrl(); ?>/images/headImage/config.png" class="img-rounded" height="120" width="70"></td>
    ...
    <table class="table table-hover" style="font-size: 12px;">
        ...
        <tbody>
            ...
            <tr>
                <td>
                     <label>Deseas recibir en tu correo el&eacute;ctronico informaci&oacute;n que coincidan con las notificaciones que creaste:</label>
               </td>
